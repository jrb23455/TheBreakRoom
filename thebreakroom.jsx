...
/* ---------- Brand mark: side-profile face silhouette, mouth open, four speech lines ---------- */
function BrandMark({ size = 28 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <rect x="0.5" y="0.5" width="31" height="31" rx="8" fill="#0d1220" stroke="#262f4d" />
      <path
        d="M 9,6 Q 19,5 20.5,12 Q 22,13 20.5,14.5 Q 19,16 20,18 Q 18.5,20 16,21.5 Q 11,24 8,23 Q 5,21 5,16 Q 5,9 9,6 Z"
        fill="#e9edf7"
      />
      <circle cx="13" cy="10" r="0.9" fill="#0d1220" />
      <ellipse cx="19.3" cy="17.4" rx="1.5" ry="1.1" fill="#0d1220" />
      <line x1="22.5" y1="15" x2="26.2" y2="12.8" stroke="#88aef1" strokeWidth="2.1" strokeLinecap="round" />
      <line x1="23" y1="17.5" x2="27.5" y2="17" stroke="#e2a84d" strokeWidth="2.1" strokeLinecap="round" />
      <line x1="23" y1="20" x2="27.8" y2="21" stroke="#74c690" strokeWidth="2.1" strokeLinecap="round" />
      <line x1="22" y1="22.3" x2="25" y2="24.8" stroke="#e0718a" strokeWidth="2.1" strokeLinecap="round" />
    </svg>
  );
}
